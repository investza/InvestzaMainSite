        ...
        <div className="footer-left">
          ...
          <div className="footer-section-block">
            ...
            <div className="social-links">
              <a
                href="https://www.instagram.com/investza.in/"
                target="_blank"
              ...
              <a
                href="https://in.linkedin.com/company/investza"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
              >
              ...
              <a
                href="https://www.facebook.com/Investza.in/"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
              >
              ...
              <a
                href="https://www.youtube.com/@investzaWealth"
                target="_blank"
                rel="noopener noreferrer"
                className="social-icon"
              >
