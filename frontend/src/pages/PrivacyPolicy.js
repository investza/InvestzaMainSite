     ...
     <div 
      ...
      <div className="privacy-policy-content">
        <div className="privacy-policy-container">
          ...
          <h2 className="privacy-section-title">Interpretation</h2>
          ...
          <p>
            ...
            <br></br>
            <strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to INVESTZA CAPITAL, 81 Crest, 704 A, Linking Rd, Santacruz (West), Mumbai, Maharashtra 400054.<br></br>
            <br></br>
            ...
            <br></br>
            <strong>Country</strong> refers to: Maharashtra, India<br></br>
            <br></br>
            ...
            <br></br>
            <strong>Personal</strong> Data is any information that relates to an identified or identifiable individual.<br></br>
            <br></br>
            ...
            <br></br>
            <strong>Usage</strong> Data refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).<br></br>
            <br></br>
            <strong>Website</strong> refers to Investza.in, accessible from <a href="https://investza.in/">https://investza.in/</a><br></br>
            <br></br>
          ...
          <h2 className="privacy-section-title">Collecting and Using Your Personal Data
          Types of Data Collected</h2>
          <h2 className="privacy-section-title">Personal Data</h2>
          ...
          <h2 className="privacy-section-title">Usage Data</h2>
          <p className="privacy-policy-text">
          ...
          <h2 className="privacy-section-title">Tracking Technologies and Cookies</h2>
          <p className="privacy-policy-text">
...
<li><strong>With Your consent:</strong> We may disclose Your personal information for any other purpose with Your consent.</li>
          ...
          <p className="privacy-policy-text">
           ...
           <h2 className="privacy-section-title">Disclosure of Your Personal Data</h2>
                    <h2 className="privacy-section-title">Business Transactions</h2>
          <p className="privacy-policy-text">
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
          </p>

                    <h2 className="privacy-section-title">Law enforcement</h2>
          <p className="privacy-policy-text">
            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>

                    <h2 className="privacy-section-title">Other legal requirements</h2>
          <p className="privacy-policy-text">
...
If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent’s consent before We collect and use that information.
          ...
          <p className="privacy-policy-contact">For any privacy-related questions or concerns, please contact us at:</p>
